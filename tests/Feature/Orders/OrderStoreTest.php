...
class OrderStoreTest extends TestCase
{
    ...
    public function test_it_requires_an_address_that_belongs_to_the_auth_user()
    {
        $user = factory(User::class)->create();
  ...
  public function test_it_requires_a_payment_method_that_belongs_to_the_auth_user()
    {
        $user = factory(User::class)->create();
    ...
    public function test_it_fails_create_order_if_the_cart_is_empty()
    {
        $user = factory(User::class)->create();
