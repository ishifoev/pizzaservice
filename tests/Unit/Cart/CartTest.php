...
class CartTest extends TestCase
{
    ...
    public function test_it_can_check_if_the_cart__is_empty_quantities()
    {
        $cart = new Cart(
    ...
    public function test_it_returns_a_money_instance_for_a_subtotal()
    {
        $cart = new Cart(
    ...
    public function test_it_returns_a_money_instance_for_a_total()
    {
        $cart = new Cart(
    ...
    public function test_it_the_syncs_the_cart_update_quantities()
    {
        $cart = new Cart(
    ...
    public function test_it_can_return_the_total_without_shipping()
    {
        $cart = new Cart(
    ...
    public function test_it_can_return_the_total_with_shipping()
    {
        $cart = new Cart(
