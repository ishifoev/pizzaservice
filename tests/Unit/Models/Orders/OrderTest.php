...
{
	public function test_it_has_default_status_of_pending()
    {
    ...
    public function test_it_belong_to_a_user()
    {
        $order = factory(Order::class)->create([
           'user_id' => factory(User::class)->create()->id
        ]);
    ...
    public function test_it_belong_to_an_address()
    {
        $order = factory(Order::class)->create([
           'user_id' => factory(User::class)->create()->id
        ]);
    ...
    public function test_it_belong_to_a_shipping_method()
    {
        $order = factory(Order::class)->create([
           'user_id' => factory(User::class)->create()->id
        ]);
    ...
    public function test_it_belong_to_a_payment_method()
    {
        $order = factory(Order::class)->create([
           'user_id' => factory(User::class)->create()->id
        ]);
